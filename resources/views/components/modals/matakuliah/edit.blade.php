<!-- Main modal -->
<div id="matkul-edit-modal-{{ $matakuliah->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-gray-200 rounded-lg shadow-sm">
            ...
            <div
                ...
                <button type="button"
                    ...
                    data-modal-hide="matkul-edit-modal-{{ $matakuliah->id }}">
                ...
                <form class="space-y-4" method="POST" action="{{ route('matkul.update', $matakuliah->id) }}">
                    ...
                    <div>
                        ...
                        <input type="text" name="mata_kuliah" id="mata_kuliah"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            value="{{ old('mata_kuliah', $matakuliah->mata_kuliah) }}" placeholder="Masukkan lokasi"
                            required />
                    </div>
                    <div>
                        ...
                        <input type="text" name="semester" id="semester"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            value="{{ old('semester', $matakuliah->semester) }}"placeholder="Masukkan lokasi"
                            required />
                    </div>
                    <button type="submit"
