<!-- Main modal -->
<div id="edit-matkul-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-gray-200 rounded-lg shadow-sm">
            ...
            <div
                ...
                <button type="button"
                    ...
                    data-modal-hide="edit-matkul-modal">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" method="POST" action="{{ route('matkul.update', $matakuliah->id) }}">
                    @csrf
                    @method('PUT')
                    <div>
                        ...
                        <input type="text" name="kode_matkul" id="kode_matkul"
                            ...
                            placeholder="Masukkan nama kode mata kuliah"/>
                    </div>
                    <div>
                        ...
                        <input type="text" name="mata_kuliah" id="mata_kuliah"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            value="{{ old('mata_kuliah', $matakuliah->mata_kuliah) }}" placeholder="Masukkan nama mata kuliah"/>
                    </div>
                    <div>
                        <label for="semester" class="block mb-2 text-sm font-medium text-gray-900">Semester</label>
                        <input type="number" name="semester" id="semester"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            value="{{ old('semester', $matakuliah->semester) }}" placeholder="Masukkan Semester"/>
                    </div>
                    <button type="submit"
