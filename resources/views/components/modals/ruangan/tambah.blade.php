<!-- Main modal -->
<div id="ruangan-modal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-gray-200 rounded-lg shadow-sm">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" method="POST" action="{{ route('ruangan.store') }}">
                    @csrf
                    <div>
                    ...
                    <button type="submit" id="ruangan-submit-btn"
